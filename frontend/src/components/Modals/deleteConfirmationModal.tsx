      ...
      <AlertDialogContent className="rounded-3xl bg-accent">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-base">
            This action will permanently delete this invitation sended to <strong className="text-foreground border-b pb-1 border-foreground"> {data?.member?.firstName} {data?.member?.lastName}</strong> wth designation of <strong className="text-foreground border-b pb-1 border-foreground">{data?.designation}</strong>
